...
var uni = [];
uni = graduates.filter(schools => schools.university.includes('Uni'));
console.log(uni);
...
zooAnimals.forEach((element) => animalNames.push({name: element.animal_name, Scientfic: element.scientific_name}));
...
*/
const populationTotal = Object.keys(zooAnimals).reduce((previous, key) => {
  return previous + zooAnimals[key].population;
}, 0);
